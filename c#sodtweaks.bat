...
set "mod_name=Jastey's SoD Tweakpack"
set mod_version=v3
set mod_folder=c#sodtweaks
...
set mod_readme=https://gibberlings3.github.io/Documentation/readmes/readme.c%23sodtweaks.english.txt
